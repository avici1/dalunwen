...
4. [03_models/unified_pipeline](03_models/unified_pipeline/)：完整保留原 `0830/CODEX/脚本` 的 13 个 R 脚本与复现说明，以共享变量配置为阅读入口。包括数据再核查、Cox/RSF、RSFLC、JM、可选五折搜索、共同队列比较和报告生成。
5. [03_models/individual_0826](03_models/individual_0826/)：分别保存 Cox、RSF、JM、RSFLC 的单模型执行版本和辅助调参脚本。
