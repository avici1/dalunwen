-- =============================================
-- 步骤 2：创建 Schema 和表结构
-- 在 Navicat 中连接到 mimiciv 数据库后运行此脚本
-- 来源：mimic-code mimic-iv/buildmimic/postgres/create.sql
-- =============================================
...
DROP TABLE IF EXISTS mimiciv_hosp.d_hcpcs CASCADE;
...
DROP TABLE IF EXISTS mimiciv_hosp.emar_detail CASCADE;
...
DROP TABLE IF EXISTS mimiciv_hosp.emar CASCADE;
...
DROP TABLE IF EXISTS mimiciv_hosp.omr CASCADE;
...
DROP TABLE IF EXISTS mimiciv_hosp.poe_detail CASCADE;
...
DROP TABLE IF EXISTS mimiciv_hosp.poe CASCADE;
...
DROP TABLE IF EXISTS mimiciv_hosp.provider CASCADE;
...
-- icu 表
DROP TABLE IF EXISTS mimiciv_icu.caregiver CASCADE;
...
DROP TABLE IF EXISTS mimiciv_icu.ingredientevents CASCADE;
...
DROP TABLE IF EXISTS mimiciv_icu.inputevents CASCADE;
